...
Gem::Specification.new do |spec|
  ...
  spec.authors = ['Christian Rimondi', 'Alessio Rocco', 'Rainer Dema', 'Martin Samami']
  ...
  spec.add_dependency 'graphql', '>= 2', '< 2.1'
  spec.add_dependency 'rails', '>= 6.1', '< 8.0'
  spec.add_dependency 'solidus_core', ['>= 2.10', '< 4']
  spec.add_dependency 'solidus_support', '~> 0.8'

  spec.add_development_dependency 'graphql-docs', '~> 3'
  spec.add_development_dependency 'graphql-schema_comparator', '~> 1.1.1'
